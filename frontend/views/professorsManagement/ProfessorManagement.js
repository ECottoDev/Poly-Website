        ...
        appendChildren(this.view, [
            appendChildren(addClasses(createElementContainer(), "professorManagement_scrollAreaHeader"), [
                ...
                appendChildren(addClasses(createElementContainer(), 'professorManagement_buttonAndSearch'), [
                    ...
                    addEvent(addClasses(createButton('Añadir Profesor'), "professorManagement_addProfessorButton"), () => { const close = this.parentProps.displayBox(new AddProfessor(this.parentProps, () => { close(); detachChildren(this.view); this.fetch() }).view) }),
